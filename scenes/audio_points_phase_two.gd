...
func _on_short_range_player_completed():
	dialogue_manager.play_dialogue(dlg_phase_two_short_range)

func _on_mid_range_player_completed():
	dialogue_manager.play_dialogue(dlg_phase_two_mid_range)


func _on_long_range_player_completed():
	dialogue_manager.play_dialogue(dlg_phase_two_long_range)

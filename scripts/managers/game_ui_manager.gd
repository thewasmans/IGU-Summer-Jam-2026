...
func initialize(game_manager:GameManager):
	...
	_game_manager.dialogue_manager.entry_started.connect(_on_dialogue_entry_started)
	_game_manager.dialogue_manager.dialogue_completed.connect(_on_dialogue_completed)
